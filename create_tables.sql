...
CREATE TABLE ENDEREÇO(
	...
	CONSTRAINT ENDEREÇO PRIMARY KEY (CEP),
	CONSTRAINT ENDEREÇO_CPF_FK FOREIGN KEY (CPF_PESSOA) REFERENCES PESSOA (CPF)
);
...
CREATE TABLE MONITOR(
	...
	CONSTRAINT MONITOR_PK PRIMARY KEY (CPF_MONITOR, NOME),
	CONSTRAINT CPF_MONITOR_FK FOREIGN KEY (CPF_MONITOR) REFERENCES PESSOA (CPF)
);
...
ALTER TABLE PLANO_ESTUDANTE ADD DATA_INICIO DATE;
ALTER TABLE PLANO_ESTUDANTE ADD DATA_FIM DATE;
